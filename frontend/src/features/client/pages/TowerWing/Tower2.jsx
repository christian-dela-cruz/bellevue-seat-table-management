...
function ModalShell({ children, onClose, disabled, C, maxWidth = 500 }) {
  return (
    ...
    >
      <div style={{ background: "#111009", borderRadius: 14, width: "100%", maxWidth, maxHeight: "calc(100vh - 40px)", overflowY: "auto", boxShadow: "0 24px 80px rgba(0,0,0,0.50)", border: "1px solid rgba(255,255,255,0.08)", fontFamily: F.body, position: "relative", animation: "modalIn 0.20s cubic-bezier(0.16,1,0.3,1)", overflow: "hidden" }}>
...
function ModalHeader({ eyebrow, title, onClose, disabled, C, meta }) {
  return (
    <div style={{ background: "linear-gradient(160deg,#111009 0%,#161410 100%)", padding: "26px 28px 22px", position: "sticky", top: 0, zIndex: 2, borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
      ...
      <div style={{ padding: "26px 26px 28px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          ...
          <div>
            ...
            <div style={{ fontFamily: F.display, fontSize: 22, fontWeight: 600, color: "#EDE8DF", lineHeight: 1.2 }}>Request Submitted</div>
          </div>
        </div>
